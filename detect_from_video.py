...
if __name__ == '__main__':
    ...
    p.add_argument('--video_path', '-i', type=str, default = '/home/hail/Documents/swapface_1105/swapface_1105/real_video/c2.mp4')
    #p.add_argument('--model_path', '-mi', type=str, default='./output/deepfake_xception_kfold/new.pth')
    p.add_argument('--model_path', '-mi', type=str, default='/home/hail/Documents/jjw/output/deepfake_xception_last1117/best_model_fold_5.pkl')
